...
import com.blackspider.agramonia.ui.base.callback.ItemLongClickListener
...
class ViewUtils {
    companion object {
        ...
        fun getResources(): Resources {
            return AgromoniaApplication.getBaseApplicationContext().resources
        }
        ...
        fun getFont(resourceId: Int): Typeface? {
            return ResourcesCompat.getFont(AgromoniaApplication.getBaseApplicationContext(),
                    resourceId)
        }
        ...
        fun getDrawable(resourceId: Int): Drawable? {
            return ContextCompat.getDrawable(
                    AgromoniaApplication.getBaseApplicationContext(),
                    resourceId)
        }
