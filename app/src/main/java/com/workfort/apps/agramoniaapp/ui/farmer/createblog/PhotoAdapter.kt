...
import com.workfort.apps.agramoniaapp.ui.base.component.BaseViewHolder

import com.workfort.apps.agramoniaapp.databinding.ItemBlogPhotoBinding
...
class PhotoAdapter : BaseAdapter<Uri>() {
    ...
    inner class PhotoViewHolder(viewDataBinding: ViewDataBinding) : BaseViewHolder<Uri>(viewDataBinding) {
        ...
        override fun bind(item: Uri) {
            Glide.with(AgramoniaApp.getBaseApplicationContext())
                    .asDrawable()
                    .load(item)
